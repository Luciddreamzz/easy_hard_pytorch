    ...
    for idx, model_paths in enumerate(all_model_paths):
        ...
        for i, path in enumerate(model_paths):  
            ...
            for k in range(1, 21):
                ...
                z_values= count_weights_lower_than_zero(tensor1)
...
# 保存图形
plt.savefig("/Users/jianqiaolong/Downloads/hr-mnist-pytorch/resultb100l5lr0001-fashionmnist-plot/negativeweightnum3clus_lineplot_all.png", dpi=300)
