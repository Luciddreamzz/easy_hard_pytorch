...
def painthistcumulative(fc_weight_max,fc_weight_mid,fc_weight_min):
    ...
    plt.tight_layout()
    plt.savefig("/Users/jianqiaolong/Downloads/hr-mnist-pytorch/resultb100l5lr0001-fashionmnist-plot/gradient_cumulative.png", dpi=300)
    plt.show()
