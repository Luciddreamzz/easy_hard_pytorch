...
plot(model_paths3, ax, cmap, norm, cbar, "max accuracy")
plt.savefig("/Users/jianqiaolong/Downloads/hr-mnist-pytorch/resultb100l5lr0001-fashionmnist-plot/convergence_average.png", dpi=300)
plt.show()
