...
painthistoverlap(all_max_weight,all_mid_weight,all_min_weight,4)
plt.tight_layout()
plt.savefig("/Users/jianqiaolong/Downloads/hr-mnist-pytorch/resultb100l5lr0001-fashionmnist-plot/positive_gradients_distribution_overlap.png")
plt.show()