...
legend_labels = ['minacc', 'mid acc', 'maxacc']
...
# 保存图形
plt.savefig("/Users/jianqiaolong/Downloads/hr-mnist-pytorch/resultb100l5lr0001-mnist-plot/weightmean_lineplot_all.png", dpi=300)
