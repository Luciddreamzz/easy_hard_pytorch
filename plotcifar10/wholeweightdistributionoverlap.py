...
painthistoverlap(max_fc1_weight_sum,min_fc1_weight_sum,1)
painthistoverlap(max_fc2_weight_sum,min_fc2_weight_sum,2)
painthistoverlap(max_fc3_weight_sum,min_fc3_weight_sum,3)
...
plt.tight_layout()
plt.savefig("/Users/jianqiaolong/Downloads/hr-mnist-pytorch/resultb100l5lr0001-cifar10plot/whole_weight_distribution_overlap.png")
plt.show()