...
def painthistoverlap(fc_weight_max,fc_weight_min,flag):
    ...
    # positive 
    # if flag == 1:
    #     plt.xlim(xmin=-0.2, xmax=0.6)
    # elif flag == 2:
    #     plt.xlim(xmin=-0.1, xmax=0.5)
    # elif flag == 3:
    #     plt.xlim(xmin=-0.2, xmax=0.6)
    ...
    if flag == 1:
        plt.xlim(xmin=-0.75, xmax=0.2)
    elif flag == 2:
        plt.xlim(xmin=-0.4, xmax=0.2)
    elif flag == 3:
        plt.xlim(xmin=-1, xmax=0.2)
    else:
        plt.xlim(xmin=-1, xmax=0.2)
...
for i in range(1, 101):
    for j in range(1, 11):
        path = "/Users/jianqiaolong/Downloads/hr-mnist-pytorch/resultb100l5lr0001-cifar10/b100l5lr0001-{}/train_result{}/cnnmodel.pkl".format(i, j)
...
painthistoverlap(max_fc1_weight_sum_negative,min_fc1_weight_sum_negative,1)
painthistoverlap(max_fc2_weight_sum_negative,min_fc2_weight_sum_negative,2)
painthistoverlap(max_fc3_weight_sum_negative,min_fc3_weight_sum_negative,3)
...
painthistoverlap(all_max_weight,all_min_weight,4)

# painthistoverlap(max_fc1_weight_sum_positive,min_fc1_weight_sum_positive,1)
# painthistoverlap(max_fc2_weight_sum_positive,min_fc2_weight_sum_positive,2)
# painthistoverlap(max_fc3_weight_sum_positive,min_fc3_weight_sum_positive,3)
...
plt.tight_layout()
plt.savefig("/Users/jianqiaolong/Downloads/hr-mnist-pytorch/resultb100l5lr0001-cifar10plot/negative_weight_distribution_overlap.png")
plt.show()