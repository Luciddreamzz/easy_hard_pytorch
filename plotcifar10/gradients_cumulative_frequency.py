...
def painthistcumulative(fc_weight_max,fc_weight_min):
    ...
    # ax3.set_title('Gradients histogram of mid accuracy', fontsize=7)
    ...
    # ax4.set_title('Gradients Cumulative histogram of mid accuracy', fontsize=7)
    ...
    plt.tight_layout()
    plt.savefig("/Users/jianqiaolong/Downloads/hr-mnist-pytorch/resultb100l5lr0001-cifar10plot/gradient_cumulative.png", dpi=300)
    plt.show()
