...
def scatter_with_accuracy(x, y, accuracy, ax, vmin, vmax, accuracy_type):
    ...
    #maxmin
    axs[0].set_ylim(-0.01, 6)
    axs[0].set_xlim(-1, 35)
    axs[1].set_ylim(-20, 700)
    axs[1].set_xlim(-0.02, 5)
    axs[2].set_ylim(-20, 700)
...
# for i in range(100):
#     for j in range(10):
#         path1 = f"/Users/jianqiaolong/Downloads/hr-mnist-pytorch/resultb100l5lr0001-cifar10/b100l5lr0001-{i+1}/train_result{j+1}/cnnmodel.pkl"
...
plt.savefig("/Users/jianqiaolong/Downloads/hr-mnist-pytorch/resultb100l5lr0001-cifar10plot/avgneareststrengthminmax.png", dpi=300)
plt.show()
