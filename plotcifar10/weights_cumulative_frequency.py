...
def painthistcumulative(fc_weight_max,fc_weight_min):
    ...
    ax3.hist(fc_weight_min, bins=getbins(fc_weight_min),color="salmon")
    ax3.set_title('Weight histogram of min accuracy', fontsize=7)
    ax3.set_xlabel('Weights',fontsize=6)
    ax3.set_ylabel('frequency', fontsize=6)
    ax3.tick_params(axis='both', which='major', labelsize=4)
    ...
    ax4.bar(x_min, min_cumfreq.cumcount,width=0.02,color="salmon")
    ax4.set_title('Weight Cumulative histogram of min accuracy', fontsize=7)
    ax4.set_xlabel('Weights',fontsize=6)
    ax4.set_ylabel('Cumulative frequency', fontsize=6)
    ax4.tick_params(axis='both', which='major', labelsize=4)
    ...
    plt.tight_layout()
    plt.savefig("/Users/jianqiaolong/Downloads/hr-mnist-pytorch/resultb100l5lr0001-cifar10plot/weights_cumulative.png", dpi=300)
    plt.show()
...
painthistcumulative(all_max_weight,all_min_weight)
