...
for i in range(1, 11):
    for j in range(1, 11):
        path = "/Users/jianqiaolong/Downloads/hr-mnist-pytorch/result/b100l5lr0001-{}/train_result{}/train_history_dic.pkl".format(i, j)
...
plt.savefig("/Users/jianqiaolong/Downloads/hr-mnist-pytorch/result_process/plotvresult_b100l5r0001e20/convergence.png", dpi=300)
plt.show()
