...
def painthistcumulative(fc_weight_max, fc_weight_mid, fc_weight_min, figure_name):
    ...
    #cum_freq_max = cum_hist_max / cum_hist_max[-1]
    #cum_freq_mid = cum_hist_mid / cum_hist_mid[-1]
    #cum_freq_min = cum_hist_min / cum_hist_min[-1]
    ...
    ax2.set_xlim([x_max.min(), x_max.max()])
    ...
    ax3.hist(fc_weight_mid, bins=getbins(fc_weight_mid))
    ax4.bar(x_mid, mid_cumfreq.cumcount,width=0.02,color="lightgreen")
    ...
    ax4.set_xlim([x_mid.min(), x_mid.max()])
    ...
    ax5.hist(fc_weight_min, bins=getbins(fc_weight_min))
    ax6.bar(x_min, min_cumfreq.cumcount,width=0.02,color="lightskyblue")
    ...
    ax6.set_xlim([x_min.min(), x_min.max()])

    plt.tight_layout()
    plt.savefig("/Users/jianqiaolong/Downloads/hr-mnist-pytorch/result/weight_cumulative.png", dpi=300)
    plt.show()
