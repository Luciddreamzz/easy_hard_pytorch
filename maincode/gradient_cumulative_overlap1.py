...
def painthistcumulative(fc_weight_max, fc_weight_mid, fc_weight_min, figure_name):
    ...
    ax.set_title('Gradient Cumulative Histogram Overlap', fontsize=12)
    ax.set_xlabel('Gradients', fontsize=10)
    ax.set_ylabel('Cumulative frequency', fontsize=10)
    ax.tick_params(axis='both', which='major', labelsize=8)
    ax.legend(fontsize=8)
    plt.tight_layout()
    plt.savefig("/Users/jianqiaolong/Downloads/hr-mnist-pytorch/result/Gradient_cumulative_overlap1.png", dpi=300)
    plt.show()
