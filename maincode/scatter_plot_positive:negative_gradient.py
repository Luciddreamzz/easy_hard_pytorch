...
def scatter_with_accuracy(x, y, accuracy, ax, vmin, vmax):
    ...
    #ax.set_xlabel('positive gradient',fontsize=7)
    #ax.set_ylabel('negative gradient',fontsize=7)
...
#plt.savefig("/Users/jianqiaolong/Downloads/hr-mnist-pytorch/result_process/plotvresult_b100l5r0001e20/mean_scatter_positive_negative_gradient.png", dpi=300)
#plt.savefig("/Users/jianqiaolong/Downloads/hr-mnist-pytorch/result_process/plotvresult_b100l5r0001e20/std_scatter_positive_negative_gradient.png", dpi=300)
#plt.savefig("/Users/jianqiaolong/Downloads/hr-mnist-pytorch/result_process/plotvresult_b100l5r0001e20/mean_std_scatter_positive_gradient.png", dpi=300)
plt.savefig("/Users/jianqiaolong/Downloads/hr-mnist-pytorch/result_process/plotvresult_b100l5r0001e20/mean_std_scatter_negative_gradient.png", dpi=300)
plt.show()
