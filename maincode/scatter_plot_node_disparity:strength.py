...
def scatter_with_accuracy(x, y, accuracy, ax, vmin, vmax):
    ...
    ax.set_xlabel('node dispaity',fontsize=7)
    ax.set_ylabel('node strength',fontsize=7)
    #ax.set_xlabel('mean',fontsize=7)
    #ax.set_ylabel('std',fontsize=7)
    axs[0].set_xlim(0, 20)  # set x-axis arrange(0,100)
...
# plot sactter of input edges sum node disparity and sum node strength
    scatter_with_accuracy(z1, s1, accuracy, axs[0], vmin, vmax)
    scatter_with_accuracy(z2, s2, accuracy, axs[1], vmin, vmax)
    scatter_with_accuracy(z3, s3, accuracy, axs[2], vmin, vmax)

# plot sactter of input edges sum node disparity and sum node strength--positive part
    #scatter_with_accuracy(z4, s4, accuracy, axs[0], vmin, vmax)
    #scatter_with_accuracy(z5, s5, accuracy, axs[1], vmin, vmax)
    #scatter_with_accuracy(z6, s6, accuracy, axs[2], vmin, vmax)

# plot sactter of input edges sum node disparity and sum node strength--negative part
    #scatter_with_accuracy(z7, s7, accuracy, axs[0], vmin, vmax)
    #scatter_with_accuracy(z8, s8, accuracy, axs[1], vmin, vmax)
    #scatter_with_accuracy(z9, s9, accuracy, axs[2], vmin, vmax)

# plot sactter of output edges sum node disparity and sum node strength
    #scatter_with_accuracy(o1, t1, accuracy, axs[0], vmin, vmax)
    #scatter_with_accuracy(o2, t2, accuracy, axs[1], vmin, vmax)
    #scatter_with_accuracy(o3, t3, accuracy, axs[2], vmin, vmax)
    
# plot sactter of output edges sum node disparity and sum node strength--positive part
    #scatter_with_accuracy(o4, t4, accuracy, axs[0], vmin, vmax)
    #scatter_with_accuracy(o5, t5, accuracy, axs[1], vmin, vmax)
    #scatter_with_accuracy(o6, t6, accuracy, axs[2], vmin, vmax)

# plot sactter of output edges sum node disparity and sum node strength--negative part
    #scatter_with_accuracy(o7, t7, accuracy, axs[0], vmin, vmax)
    #scatter_with_accuracy(o8, t8, accuracy, axs[1], vmin, vmax)
    #scatter_with_accuracy(o9, t9, accuracy, axs[2], vmin, vmax)
...
plt.savefig("/Users/jianqiaolong/Downloads/hr-mnist-pytorch/result_process/plotvresult_b100l5r0001e20/sactter_node_disparity_and_strength_input_edges.png", dpi=300)
