...
def predict_test(i, j): 
    ...
    path = f'/Users/jianqiaolong/Downloads/hr-mnist-pytorch/result-fashion/b100l5lr0001-{i+1}/train_result{j+1}/cnnmodel.pkl'
...
if __name__ == '__main__':
    ...
    for i in range(2):
        for j in range(2):
            ...
            __PATH__=f'/Users/jianqiaolong/Downloads/hr-mnist-pytorch/result-fashion/b100l5lr0001-{i+1}/train_result{j+1}/wholetrainhistory.pkl'
            weight_path = f'/Users/jianqiaolong/Downloads/hr-mnist-pytorch/result-fashion/b100l5lr0001-{i+1}/train_result{j+1}/weight_dic.pkl'
            gradient_path = f'/Users/jianqiaolong/Downloads/hr-mnist-pytorch/result-fashion/b100l5lr0001-{i+1}/train_result{j+1}/gradient_dic.pkl'
            history_path = f'/Users/jianqiaolong/Downloads/hr-mnist-pytorch/result-fashion/b100l5lr0001-{i+1}/train_result{j+1}/train_history_dic.pkl'
            net =Mlp(weight_path, gradient_path, history_path,__PATH__)
            net.apply(_initialize_weights)
            f1= f'/Users/jianqiaolong/Downloads/hr-mnist-pytorch/result-fashion/b100l5lr0001-{i+1}/train_result{j+1}/weights.txt'
            f2= f'/Users/jianqiaolong/Downloads/hr-mnist-pytorch/result-fashion/b100l5lr0001-{i+1}/train_result{j+1}/gradients.txt'
            f3= f'/Users/jianqiaolong/Downloads/hr-mnist-pytorch/result-fashion/b100l5lr0001-{i+1}/train_result{j+1}/trainhistory.txt'
            ...
            torch.save(net_state_dict,f'/Users/jianqiaolong/Downloads/hr-mnist-pytorch/result-fashion/b100l5lr0001-{i+1}/train_result{j+1}/cnnmodel.pkl')  # 保存整个模型
        ...
        **************************************************************  
            ...
            a=[test_accuracy]        
            print(a)
            csvfilesave(f'/Users/jianqiaolong/Downloads/hr-mnist-pytorch/result-fashion/accuracy.csv',a)
            csvfilesave(f'/Users/jianqiaolong/Downloads/hr-mnist-pytorch/result-fashion/b100l5lr0001-{i+1}/accuracy.csv',a)
            #---------------------------------varify code----------------------------------------------------
            predict_test(i,j)
