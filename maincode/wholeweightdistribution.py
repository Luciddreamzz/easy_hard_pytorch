...
painthist(max_fc1_weight_sum,"layer1 weight distribution of all max-accuracy network",1,1)
painthist(mid_fc1_weight_sum,"layer1 weight distribution of all mid-accuracy network",2,2)
painthist(min_fc1_weight_sum,"layer1 weight distribution of all min-accuracy network",3,3)
painthist(max_fc2_weight_sum,"layer2 weight distribution of all max-accuracy network",1,4)
painthist(mid_fc2_weight_sum,"layer2 weight distribution of all mid-accuracy network",2,5)
painthist(min_fc2_weight_sum,"layer2 weight distribution of all min-accuracy network",3,6)
painthist(max_fc3_weight_sum,"layer3 weight distribution of all max-accuracy network",1,7)
painthist(mid_fc3_weight_sum,"layer3 weight distribution of all mid-accuracy network",2,8)
painthist(min_fc3_weight_sum,"layer3 weight distribution of all min-accuracy network",3,9)
plt.tight_layout()
plt.savefig("/Users/jianqiaolong/Downloads/hr-mnist-pytorch/result/whole_weights_distribution.png")
plt.show()