...
def painthistcumulative(fc_weight_max, fc_weight_mid, fc_weight_min, figure_name):
    ...
    # Set plot parameters
    ax.set_title('Weight Cumulative Histogram', fontsize=12)
    ...
    # Save and show plot
    plt.tight_layout()
    plt.savefig("/Users/jianqiaolong/Downloads/hr-mnist-pytorch/result/weight_cumulative_overlap2.png", dpi=300)
    plt.show()
