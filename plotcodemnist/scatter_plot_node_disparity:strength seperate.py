...
def scatter_with_accuracy(x, y, accuracy, ax, vmin, vmax, accuracy_type):
    ...
    if accuracy_type not in added_labels:
        ...
        im = ax.scatter(x, y, color='mediumvioletred', marker=marker_dict[accuracy_type], s=10,label=accuracy_type)
...
plt.savefig("/Users/jianqiaolong/Downloads/hr-mnist-pytorch/resultb100l5lr0001-mnist-plot/nodedisparityall.png", dpi=300)
plt.show()
