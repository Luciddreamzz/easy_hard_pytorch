...
for i in range(1, 101):
    for j in range(1, 11):
        path = "/Users/jianqiaolong/Downloads/hr-mnist-pytorch/resultb100l5lr0001-mnist/b100l5lr0001-{}/train_result{}/train_history_dic.pkl".format(i, j)
...
cmap = plt.cm.PiYG
test_acc = []
for path in model_paths1 + model_paths2 + model_paths3 + model_paths4:
...
plt.savefig("/Users/jianqiaolong/Downloads/hr-mnist-pytorch/resultb100l5lr0001-mnist-plot/convergence_average.png", dpi=300)
plt.show()
