...
def painthistoverlap(fc_weight_max,fc_weight_highermid,fc_weight_lowermid,fc_weight_min,flag):
    ...
    sns.distplot(fc_weight_highermid,bins=getbins1(fc_weight_highermid),kde_kws={"color":"deepskyblue", "lw":1 ,"linestyle":"-","label":"highermid accuracy"}, hist_kws={ "color": "deepskyblue" })
    sns.distplot(fc_weight_lowermid,bins=getbins1(fc_weight_highermid),kde_kws={"color":"limegreen", "lw":1 ,"linestyle":"-","label":"lowermid accuracy"}, hist_kws={ "color": "limegreen" })
    ...
    # negative
    if flag == 1:
        plt.xlim(xmin=-0.15, xmax=0.05)
        plt.ylim(ymin=0, ymax=100)
    elif flag == 2:
        plt.xlim(xmin=-3, xmax=1)
        plt.ylim(ymin=0, ymax=3)
    elif flag == 3:
        plt.xlim(xmin=-1.5, xmax=0.5)
        plt.ylim(ymin=0, ymax=6)
    else:
        plt.xlim(xmin=-0.2, xmax=0.05)
...
# painthistoverlap(all_max_weight,all_highermid_weight,all_lowermid_weight,all_min_weight,4)
plt.tight_layout()
plt.savefig("/Users/jianqiaolong/Downloads/hr-mnist-pytorch/resultb100l5lr0001-mnist-plot/negative_gradients_distribution_overlap.png")
plt.show()