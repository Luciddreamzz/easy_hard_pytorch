...
def painthistoverlap(fc_weight_max,fc_weight_highermid,fc_weight_lowermid,fc_weight_min,flag):
    ...
    #     sns.distplot(fc_weight_lowermid,bins=getbins1(fc_weight_lowermid),kde_kws={"color":"limegreen", "lw":1 ,"linestyle":"-","label":"lowermid accuracy"}, hist_kws={ "color": "limegreen" })
    ...
    if flag == 1:
        plt.xlim(xmin=-0.075, xmax=0.075)
        plt.ylim(ymin=0, ymax=300)
    elif flag == 2:
        plt.xlim(xmin=-1.5, xmax=1)
...
plt.tight_layout()
plt.savefig("/Users/jianqiaolong/Downloads/hr-mnist-pytorch/resultb100l5lr0001-mnist-plot/whole_gradients_distribution_overlap.png")
plt.show()