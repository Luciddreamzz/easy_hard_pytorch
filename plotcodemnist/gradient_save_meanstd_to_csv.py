...
for path in model_paths3:
    path1 = path
    path2 = path.replace('gradient_dic.pkl', 'train_history_dic.pkl')
    addgradient(axs, path1, path2, vmin, vmax, 3)
...
plt.savefig("/Users/jianqiaolong/Downloads/hr-mnist-pytorch/resultb100l5lr0001-mnist-plot/mean_std_scatter_gradient_minmaxmid.png", dpi=300)
plt.show()