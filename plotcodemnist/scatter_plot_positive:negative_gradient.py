...
def addweight(axs, path1, path2, vmin, vmax,flag):
    ...
    if flag==2:
        scatter_with_accuracy(fc1_positive_mean, fc1_positive_std, accuracy, axs[0], vmin, vmax,accuracy_type='lowermid accuracy')
        scatter_with_accuracy(fc2_positive_mean, fc2_positive_std, accuracy, axs[1], vmin, vmax,accuracy_type='lowermid accuracy')
        scatter_with_accuracy(fc3_positive_mean, fc3_positive_std, accuracy, axs[2], vmin, vmax,accuracy_type='lowermid accuracy')
        scatter_with_accuracy(all_positive_mean, all_positive_std, accuracy, axs[3], vmin, vmax,accuracy_type='lowermid accuracy') 
    if flag==3:
        scatter_with_accuracy(fc1_positive_mean, fc1_positive_std, accuracy, axs[0], vmin, vmax,accuracy_type='highermid accuracy')
        scatter_with_accuracy(fc2_positive_mean, fc2_positive_std, accuracy, axs[1], vmin, vmax,accuracy_type='highermid accuracy')
        scatter_with_accuracy(fc3_positive_mean, fc3_positive_std, accuracy, axs[2], vmin, vmax,accuracy_type='highermid accuracy')
        scatter_with_accuracy(all_positive_mean, all_positive_std, accuracy, axs[3], vmin, vmax,accuracy_type='highermid accuracy')
    else:
    ...
    # if flag==2:
    #     scatter_with_accuracy(fc1_negative_mean, fc1_negative_std, accuracy, axs[0], vmin, vmax,accuracy_type='lowermid accuracy')
    #     scatter_with_accuracy(fc2_negative_mean, fc2_negative_std, accuracy, axs[1], vmin, vmax,accuracy_type='lowermid accuracy')
    #     scatter_with_accuracy(fc3_negative_mean, fc3_negative_std, accuracy, axs[2], vmin, vmax,accuracy_type='lowermid accuracy')
    #     scatter_with_accuracy(all_negative_mean, all_negative_std, accuracy, axs[3], vmin, vmax,accuracy_type='lowermid accuracy') 
    # if flag==3:
    #     scatter_with_accuracy(fc1_negative_mean, fc1_negative_std, accuracy, axs[0], vmin, vmax,accuracy_type='highermid accuracy')
    #     scatter_with_accuracy(fc2_negative_mean, fc2_negative_std, accuracy, axs[1], vmin, vmax,accuracy_type='highermid accuracy')
    #     scatter_with_accuracy(fc3_negative_mean, fc3_negative_std, accuracy, axs[2], vmin, vmax,accuracy_type='highermid accuracy')
    #     scatter_with_accuracy(all_negative_mean, all_negative_std, accuracy, axs[3], vmin, vmax,accuracy_type='highermid accuracy')
    # else:
...
for i in range(100):
    for j in range(10):
        path1 = f"/Users/jianqiaolong/Downloads/hr-mnist-pytorch/resultb100l5lr0001-mnist/b100l5lr0001-{i+1}/train_result{j+1}/gradient_dic.pkl"
...
plt.savefig("/Users/jianqiaolong/Downloads/hr-mnist-pytorch/resultb100l5lr0001-mnist-plot/mean_std_scatter_positive_gradient.png", dpi=300)
plt.show()
