...
plot(model_paths5, ax, cmap, norm, cbar, "min accuracy")
plot(model_paths3, ax, cmap, norm, cbar, "mid accuracy")
plot(model_paths4, ax, cmap, norm, cbar, "max accuracy")
plt.savefig("/Users/jianqiaolong/Downloads/hr-mnist-pytorch/result-cnn64-7-plot/convergence_average.png", dpi=300)
plt.show()
