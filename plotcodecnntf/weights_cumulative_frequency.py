...
def painthistcumulative(fc_weight_max, fc_weight_highermid,fc_weight_lowermid, fc_weight_min):
    ...
    ax3.set_title('Weight histogram of highermid accuracy', fontsize=7)
    ...
    ax4.set_title('Weight Cumulative histogram of highermid accuracy', fontsize=7)
    ...
    ax5.set_title('Weight histogram of lowermid accuracy', fontsize=7)
    ...
    ax6.set_title('Weight Cumulative histogram of lowermid accuracy', fontsize=7)
    ...
    ax7.set_title('Weight histogram of min accuracy', fontsize=7)
    ax7.set_xlabel('Weights',fontsize=6)
    ...
    ax8.set_title('Weight Cumulative histogram of min accuracy', fontsize=7)
    ax8.set_xlabel('Weights',fontsize=6)
    ...
    plt.tight_layout()
    plt.savefig("/Users/jianqiaolong/Downloads/hr-mnist-pytorch/resultb100l5lr0001-mnist-plot/weights_cumulative.png", dpi=300)
    plt.show()
