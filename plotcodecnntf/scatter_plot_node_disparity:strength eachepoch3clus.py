    ...
    for idx, model_paths in enumerate(all_model_paths):
        ...
        for i, path in enumerate(model_paths):  
            ...
            for k in range(1, 21):
                ...
                if ax_index==0:
                    z_values,_= nodesproperty(tensor1,input_size,node1,flag=1)
                if ax_index==1:
                    z_values,_= nodesproperty(tensor1,node1,node2,flag=1)
                if ax_index==2:
                    z_values,_= nodesproperty(tensor1,node2,output_size,flag=1)
...
# 保存图形
plt.savefig("/Users/jianqiaolong/Downloads/hr-mnist-pytorch/resultb100l5lr0001-mnist-plot/nodedisparity3clus_lineplot_allcliplog.png", dpi=300)
